...
ggsave(paste0(config$image_save_directory,'figure_s10_select_species_param_comparison1.png'), plot=select_species_1, height=40,dpi=200, width=30, units = 'cm')
ggsave(paste0(config$image_save_directory,'figure_s11_select_species_param_comparison2.png'), plot=select_species_2, height=40,dpi=200, width=30, units = 'cm')

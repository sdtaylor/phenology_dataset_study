...
ggsave(paste0(config$image_save_directory,'figure_s8_hubbard_harvard_comparison1.png'), plot=hubbard_hubbard_1, height=40, width=30,dpi=200, units = 'cm')
ggsave(paste0(config$image_save_directory,'figure_s9_hubbard_harvard_comparison2.png'), plot=hubbard_hubbard_2, height=40, width=30,dpi=200, units = 'cm')

...
%%%%%%%%%%%%%%%%%%%%%%
%% Figure 2 Legend , parameter comparison
%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%
%% Figure 3 Legend, estimate comparison (1:1 graphs w/ yellow and
%% green points
%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%
%% Figure 4 Legend, error comparison (2 rows of density plots)
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[H]
	\centering
		\includegraphics[scale=0.65]{figure_2_param_comparison_final.png}
    \caption{.}
\end{figure}
...
\begin{figure}[H]
	\centering
		\includegraphics[scale=0.4]{figure_3_estimate_compare.png}
	\caption{.}
\end{figure}
...
\begin{figure}[H]
	\centering
		\includegraphics[scale=0.3]{figure_4_rmse_metrics_density_plot.png}
	\caption{.}
\end{figure}
